   ...
   <section className="container--outer outer--black section--three">
      <div className="container--inner inner--black inner--three">
        ...
        <div className="col--60">
          ...
          <p className="intro-p">Following our own IBM Enterprise Design Thinking loop, we completed extensive research to understand our users' pain points and build empathy to design and deliver an elegant product.</p>
        </div>   
      </div>
    </section>
  )
